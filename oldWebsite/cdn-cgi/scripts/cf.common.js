...
!(function(e) {
  ...
  function a(e, t, n) {
    ...
    return (
      n != null && e
        ? ((s = e.split(r)), (o = s[l(t, n)] || s[0]), (i = u(o)))
        : (i = e),
      i
    )
  }
  ...
  (t.VERSION = '0.2.0'),
    ...
    (t.prototype.extend = function(e) {
      for (const t in e) e.hasOwnProperty(t) && (this.phrases[t] = e[t])
    }),
    ...
    (t.prototype.t = function(e, t) {
      let n
      t = t || {}
      const r = this.phrases[e] || t._ || ''
      return (
        r === ''
          ? (h('Missing translation for key: "' + e + '"'), (n = e))
          : ((t = p(t)),
            t.smart_count != null &&
              t.smart_count.length != null &&
              (t.smart_count = t.smart_count.length),
            (n = a(r, this.currentLocale, t.smart_count)),
            (n = c(n, t))),
        n
      )
    }),
    (t.prototype.pluralize = function(e, t) {
      t != null && t.length != null && (t = t.length)
      const r = n(e)
      return this.t(r, { smart_count: t })
    })
  var r = '||||',
    i = {
      chinese: function(e) {
...
;(function($, Polyglot, window, navigator, undefined) {
  const polyglot = (window.polyglot = new Polyglot())
  ...
  function translate(json) {
    ...
    $.each(polyglot.phrases, function(key, val) {
      $('[data-translate=' + key + ']').html(val)
    })
  }
  ...
  $(function() {
    const alertContainer = $('<label/>', { class: 'alert alert-error' }),
    ...
    languageSelect.on('change', function(evt) {
      ...
      if (lang) {
        $.getJSON('/cdn-cgi/scripts/lang/waf/' + lang + '.json', function(
          data
        ) {
