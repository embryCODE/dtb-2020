...
const Zepto = (function() {
  ...
  function G(t, e) {
    e(t)
    for (let n = 0, i = t.childNodes.length; i > n; n++) G(t.childNodes[n], e)
  }
  var t,
    e,
    n,
  ...
  return (
    ...
    (n.fn = {
      ...
      text: function(t) {
        return 0 in arguments
          ? this.each(function(e) {
              const n = J(this, t, e, this.textContent)
      ...
      data: function(e, n) {
        const i = 'data-' + e.replace(m, '-$1').toLowerCase(),
              ...
              (o = i ? u : u.parentNode),
                (u =
                  0 == e
                    ...
                    ? u
                    : null)
              const f = n.contains(a.documentElement, o)
  ...
  (function(t) {
      ...
      i.split(/\s/).forEach(function(i) {
        ...
        ;(s.proxy = function(t) {
          if (((t = j(t)), !t.isImmediatePropagationStopped())) {
            t.data = o
            const i = l.apply(e, t._args == n ? [t] : [t].concat(t._args))
    ...
    ;(a.click = a.mousedown = a.mouseup = a.mousemove = 'MouseEvents'),
      ...
      (t.proxy = function(e, n) {
        const s = 2 in arguments && i.call(arguments, 2)
        if (r(e)) {
          const a = function() {
    ...
    ;(t.fn.delegate = function(t, e, n) {
      ...
      (t.Event = function(t, e) {
        o(t) || ((e = t), (t = e.type))
        let n = document.createEvent(a[t] || 'Events'),
          i = !0
        if (e) for (const r in e) 'bubbles' == r ? (i = !!e[r]) : (n[r] = e[r])
          ...
          (d.onreadystatechange = function() {
            if (4 == d.readyState) {
              ...
              if (
                ...
                (s =
                  s || b(n.mimeType || d.getResponseHeader('content-type'))),
                  (e = d.responseText)
                try {
                  'script' == s
                    ? (1, eval)(e)
