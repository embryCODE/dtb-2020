...
(window.Modernizr = (function(a, b, c) {
  ...
  function J() {
    (e.input = (function(c) {
      for (let d = 0, e = c.length; d < e; d++) u[c[d]] = c[d] in k
      return (
        u.list &&
  ...
  !E(A, 'undefined') && !E(A.call, 'undefined')
    ...
    (s.canvas = function() {
      const a = b.createElement('canvas')
    ...
    (s.fontface = function() {
      ...
      return (
        y('@font-face {font-family:"font";src:url("https://")}', function(
          ...
          const e = b.getElementById('smodernizr'),
  ...
  return (
    ...
    (e.addTest = function(a, b) {
      if (typeof a == 'object') for (const d in a) B(a, d) && e.addTest(d, a[d])
      else {
        a = a.toLowerCase()
        if (e[a] !== c) return e
