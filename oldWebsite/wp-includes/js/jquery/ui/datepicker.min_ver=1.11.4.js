...
!(function(e) {
  ...
  function h(e, t) {
    for (const a in (b.extend(e, t), t)) null == t[a] && (e[a] = t[a])
    return e
  }
  return (
    ...
    b.extend(e.prototype, {
            ...
            (t.trigger = b(
              this._get(t, 'buttonImageOnly')
                ...
                : b("<button type='button'></button>")
                    .addClass(this._triggerClass)
                    .html(
                      s ? b('<img/>').attr({ src: s, alt: i, title: i }) : i
                    )
            )),
      ...
      _dialogDatepicker: function(e, t, a, i, s) {
        ...
        return (
          l ||
            ...
            ((l = this._dialogInst = this._newInst(
              this._dialogInput,
              !1
            )).settings = {}),
      ...
      _doKeyDown: function(e) {
        ...
        if (((s._keyEvent = !0), b.datepicker._datepickerShowing))
          switch (e.keyCode) {
            ...
            case 37:
              (e.ctrlKey || e.metaKey) &&
                b.datepicker._adjustDate(e.target, n ? 1 : -1, 'D'),
                (r = e.ctrlKey || e.metaKey),
      ...
      _doKeyPress: function(e) {
        ...
        if (b.datepicker._get(i, 'constrainInput'))
          return (
            (t = b.datepicker._possibleChars(
              b.datepicker._get(i, 'dateFormat')
            )),
      ...
      _doKeyUp: function(e) {
        const t = b.datepicker._getInst(e.target)
      ...
      _showDatepicker: function(e) {
        ...
        'input' !== (e = e.target || e).nodeName.toLowerCase() &&
          ...
          b.datepicker._isDisabledDatepicker(e) ||
            ...
            !1 !==
              (i = (a = b.datepicker._get(t, 'beforeShow'))
                ? a.apply(e, [e, t])
                : {}) &&
              (h(t.settings, i),
              (t.lastVal = null),
      ...
      _checkOffset: function(e, t, a) {
        const i = e.dpDiv.outerWidth(),
          ...
          d =
            ...
            (a ? 0 : b(document).scrollLeft()),
          c =
            document.documentElement.clientHeight +
            (a ? 0 : b(document).scrollTop())
        return (
      ...
      _findPos: function(e) {
        for (
          ...
          e &&
          ('hidden' === e.type || 1 !== e.nodeType || b.expr.filters.hidden(e));
      ...
      _adjustDate: function(e, t, a) {
        ...
        this._isDisabledDatepicker(i[0]) ||
          (this._adjustInstDate(
            s,
            t + ('M' === a ? this._get(s, 'showCurrentAtPos') : 0),
            a
          ),
      ...
      _selectDay: function(e, t, a, i) {
        ...
        b(i).hasClass(this._unselectableClass) ||
          ...
          (((s = this._getInst(r[0])).selectedDay = s.currentDay = b(
            'a',
            i
          ).html()),
      ...
      parseDate: function(a, r, e) {
        ...
        if ('' === (r = 'object' == typeof r ? r.toString() : r + ''))
          return null
        function n(e) {
          const t = d + 1 < a.length && a.charAt(d + 1) === e
          return t && d++, t
        }
        function t(e) {
          const t = n(e),
      ...
      formatDate: function(a, e, t) {
        if (!e) return ''
        function s(e) {
          const t = n + 1 < a.length && a.charAt(n + 1) === e
          return t && n++, t
        }
        function i(e, t, a) {
          let i = '' + t
      ...
      _possibleChars: function(a) {
        function e(e) {
          const t = i + 1 < a.length && a.charAt(i + 1) === e
          return t && i++, t
        }
        let i,
          t = '',
      ...
      _restrictMinMax: function(e, t) {
        const a = this._getMinMaxDate(e, 'min'),
